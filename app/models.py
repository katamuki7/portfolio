...
class Profile(models.Model):
    ...
    atcoder = models.CharField('atcoder', max_length=100, null=True, blank=True)
...
class Work(models.Model):
    ...
    urlname = models.CharField('URLNAME', max_length=100, null=True, blank=True)
    url2 = models.CharField('URL', max_length=100, null=True, blank=True)
